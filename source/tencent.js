var document = {
URL: "https://v.qq.com/x/cover/gehpfier9upkqz5/1",
referrer: ""
}
...
///////////////////////////////// load wasm ///////////////////////////////////////
const fs = require('fs');
var wasm_data = fs.readFileSync('D:/Workspaces/Idea/DownloadManager/source/ckey.wasm')
//var wasm_data = fs.readFileSync('https://vm.gtimg.cn/tencentvideo/txp/js/ckey.wasm?v=20171208')
...
console.log(getckey('10201', '3.5.57', '1', '', '1fcb9528b79f2065c9a281a7d554edd1', '1627280135'));
